  ...
  <div className="flex justify-between items-center px-4 py-6 sm:px-6 md:justify-start md:space-x-10">
    ...
    <div className="hidden md:flex-1 md:flex md:items-center md:justify-between">
      ...
      <div className="flex items-center md:ml-12">
        ...
        <Link href="/signup" >
           <a className="ml-8 inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700">Sign up</a>
         </Link>
      </div>
    </div>
  </div>
